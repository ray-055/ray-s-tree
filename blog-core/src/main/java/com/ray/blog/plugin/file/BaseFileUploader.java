package com.ray.blog.plugin.file;

import com.ray.blog.business.entity.File;
import com.ray.blog.business.entity.User;
import com.ray.blog.business.enums.ConfigKeyEnum;
import com.ray.blog.business.service.BizFileService;
import com.ray.blog.business.service.SysConfigService;
import com.ray.blog.file.AliyunOssApiClient;
import com.ray.blog.file.ApiClient;
import com.ray.blog.file.LocalApiClient;
import com.ray.blog.file.QiniuApiClient;
import com.ray.blog.file.entity.VirtualFile;
import com.ray.blog.file.exception.GlobalFileException;
import com.ray.blog.framework.exception.Exception;
import com.ray.blog.framework.holder.SpringContextHolder;
import com.ray.blog.persistence.beans.BizFile;
import com.ray.blog.util.BeanConvertUtil;
...
public class BaseFileUploader {
    ...
    ApiClient getApiClient(String uploadType) {
        ...
        if (null == config || StringUtils.isEmpty((storageType = (String) config.get(ConfigKeyEnum.STORAGE_TYPE.getKey())))) {
            throw new Exception("[文件服务]当前系统暂未配置文件服务相关的内容！");
        }
