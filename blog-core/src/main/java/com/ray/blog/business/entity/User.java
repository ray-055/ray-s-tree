...
import com.ray.blog.business.enums.*;
import com.ray.blog.framework.object.AbstractBO;
...
public class User extends AbstractBO {
    ...
    public User() { this.sysUser = new SysUser(); }

    public User(SysUser sysUser) { this.sysUser = sysUser; }
...
//    }
    ...
    public String getLastLoginIp() {return this.sysUser.getLastLoginIp();}
    ...
    public UserStatusEnum getStatusEnum() {
        return UserStatusEnum.getByCode(this.sysUser.getStatus());
    }
